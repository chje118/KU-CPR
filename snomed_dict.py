...
SNOMED_patterns = {
    ...
    "Mamma": r"T04.*",
    "Hæmatopoietisk og retikuloendotelialt system": r"T0[56].*",
    "Milt" : r"T07.*",
    "Lymfesystem": r"T0[89].*",
    "Blod": r"T0X.*",
    "Cytologi": r"T0Y.*",
    "Knoglesystem": r"T1[012].*",
    "Skeletmuskulatur": r"T1[34].*",
    "Bursa": r"T16.*",
    "Sener og ligamenter": r"T1[78].*",
    "Bløddelsvæv": r"T1X.*",
    "Synovialvæske": r"T1Y.*",
    ...
    "Esophagus": r"T62.*",
    "Ventrikel": r"T63.*",
    "Tarmsystem": r"T6[4-9].*|T50000|T50100|T50500",
    "Cytologi, tarmsystem": r"T6[X].*",
    "Fæces": r"T6Y.*",
    "Urogenitale system": r"T70000",
    "Nyrer": r"T7[12].*",
    "Ureter": r"T73.*",
    "Urinblære": r"T74.*",
    "Urethra": r"T75.*",
